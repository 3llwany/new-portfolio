...
import {DOCUMENT, NgIf, NgClass, NgStyle} from "@angular/common";
...
import {VerticalMenuComponent} from "app/shared/vertical-menu/vertical-menu.component";
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, SidebarDirective, NgClass, VerticalMenuComponent, NgStyle, RouterOutlet, FooterComponent]
})
